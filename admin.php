...
.badge{background:var(--primary-solid);color:#fff;font-size:11px;padding:3px 10px;border-radius:20px}
...
.user-item,.link-item{border-bottom:1px solid var(--border);padding:12px 0}
.user-item{display:flex;justify-content:space-between;align-items:center}
.user-info .name{font-weight:600}
.user-info .email,.user-info .meta,.meta-line,.long-url{font-size:12px;color:var(--muted);margin-top:2px}
.short-url a{color:var(--accent);text-decoration:none;font-weight:600;font-size:14px;word-break:break-all}
.long-url{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.btn-del,.del-btn{background:var(--err-bg);color:var(--err);border:1px solid var(--err);padding:6px 12px;border-radius:8px;font-size:12px;text-decoration:none}
...
.nav-item{display:flex;flex-direction:column;align-items:center;text-decoration:none;color:var(--muted);font-size:10px;gap:2px;padding:6px 8px;border-radius:12px;min-width:52px}
...
.credit{margin:24px 0 12px;padding:16px;background:var(--bg2);border:1px solid var(--border);border-radius:16px;text-align:center}
.credit .by{font-size:13px;color:var(--muted);margin-bottom:6px}
.credit .name{font-size:15px;font-weight:700;color:var(--heading)}
.credit .msg{background:transparent;color:var(--muted);font-size:12px;padding:8px 0 0;margin:0;text-align:center}
.credit .wa{display:inline-flex;align-items:center;gap:8px;margin-top:12px;background:#25D366;color:#fff;padding:10px 18px;border-radius:12px;text-decoration:none;font-weight:600;font-size:14px}
.credit .wa svg{width:18px;height:18px}
</style>
</head>
<body>
<div class="header">
...
<div class="credit">
<div class="by">Coded by</div>
<div class="name"><?= htmlspecialchars($CREDIT_NAME) ?></div>
<p class="msg">Hi, I just visited your ShortLink tool.</p>
<a class="wa" href="<?= htmlspecialchars($waLink) ?>" target="_blank" rel="noopener"><i data-lucide="message-circle"></i> WhatsApp</a>
</div>
</div>
