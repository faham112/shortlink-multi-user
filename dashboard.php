...
.site-footer{width:100%;margin:20px 0 8px;padding:10px 14px;background:var(--bg2);border:1px solid var(--border);border-radius:14px}
.site-footer-inner{display:flex;flex-direction:column;align-items:center;justify-content:space-between;gap:8px;text-align:center}
@media(min-width:480px){.site-footer-inner{flex-direction:row;text-align:left}}
.footer-brand{display:flex;align-items:center;gap:5px;font-size:11px;color:var(--muted);font-weight:500}
.footer-brand .heart{color:#a78bfa;font-size:10px;animation:pulse-heart 1.4s ease-in-out infinite}
@keyframes pulse-heart{0%,100%{opacity:1;transform:scale(1)}50%{opacity:.7;transform:scale(1.15)}}
.footer-brand .name{color:var(--heading);font-weight:600;font-size:11px}
.footer-wa{display:inline-flex;align-items:center;gap:5px;padding:3px 10px;border-radius:999px;background:rgba(124,58,237,.12);border:1px solid rgba(167,139,250,.35);color:var(--accent);text-decoration:none;font-size:11px;font-weight:500;transition:.2s}
.footer-wa:hover{background:rgba(124,58,237,.22)}
.footer-wa i{font-size:12px}
[data-theme="light"] .footer-wa{background:rgba(124,58,237,.08);border-color:rgba(109,40,217,.25);color:#6d28d9}
[data-theme="light"] .footer-brand .heart{color:#7c3aed}
</style>
</head>
<body>
<div class="header">
